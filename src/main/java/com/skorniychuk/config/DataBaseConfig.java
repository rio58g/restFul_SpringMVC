...
public class DataBaseConfig {
    ...
    public Properties getHibernateProperties() {
        try {
            ...
            throw new IllegalArgumentException("Can`t fint 'hibernate.properties' in classpath", e);
        }
    }
    ...
    public DataSource dataSource() {
        ...
        ds.setDriverClassName(enw.getRequiredProperty("db.driver"));
        ds.setUsername(enw.getRequiredProperty("db.username"));
        ds.setPassword(enw.getRequiredProperty("db.password"));

        ds.setInitialSize(Integer.valueOf(enw.getRequiredProperty("db.initialSize")));
        ds.setMinIdle(Integer.valueOf(enw.getRequiredProperty("db.minIdle")));
        ds.setMaxIdle(Integer.valueOf(enw.getRequiredProperty("db.maxIdle")));
